...
import com.acme_ai_sdk.api.core.http.HttpClient
import com.acme_ai_sdk.api.core.http.HttpMethod
import com.acme_ai_sdk.api.core.http.HttpRequest
import com.acme_ai_sdk.api.core.http.HttpRequestBody
import com.acme_ai_sdk.api.core.http.HttpResponse
import com.acme_ai_sdk.api.errors.AcmeAiSdkIoException
...
private constructor(private val okHttpClient: okhttp3.OkHttpClient, private val baseUrl: HttpUrl) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw AcmeAiSdkIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
            ...
            .enqueue(
                object : Callback {
                    ...
                    override fun onFailure(call: Call, e: IOException) {
                        future.completeExceptionally(AcmeAiSdkIoException("Request failed", e))
                    }
                }
            )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("ACME_AI_SDK_LOG")?.lowercase()) {
