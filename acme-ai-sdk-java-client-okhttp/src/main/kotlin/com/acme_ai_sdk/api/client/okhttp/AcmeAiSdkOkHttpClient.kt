...
import com.acme_ai_sdk.api.client.AcmeAiSdkClientImpl
...
class AcmeAiSdkOkHttpClient private constructor() {
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [AcmeAiSdkOkHttpClient]. */
        @JvmStatic fun builder() = Builder()

        @JvmStatic fun fromEnv(): AcmeAiSdkClient = builder().fromEnv().build()
    }

    /** A builder for [AcmeAiSdkOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AcmeAiSdkClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AcmeAiSdkClient =
            AcmeAiSdkClientImpl(
                clientOptions
                    .httpClient(
