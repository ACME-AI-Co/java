...
import com.acme_ai_sdk.api.core.http.PhantomReachableClosingHttpClient
import com.acme_ai_sdk.api.core.http.QueryParams
import com.acme_ai_sdk.api.core.http.RetryingHttpClient
...
private constructor(
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://api.example.com/v1"
                        ...
                        object : ThreadFactory {
                            ...
                            override fun newThread(runnable: Runnable): Thread =
                                threadFactory.newThread(runnable).also {
                                    it.name =
                                        "acme-ai-sdk-stream-handler-thread-${count.getAndIncrement()}"
                                }
                        }
                    ),
                clock,
