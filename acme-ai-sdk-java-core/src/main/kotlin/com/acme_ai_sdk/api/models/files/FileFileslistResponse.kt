...
private constructor(
    ...
    ) : this(completionTime, error, fileId, fileSize, filename, status, uploadTime, mutableMapOf())
     ...
     */
    fun completionTime(): Optional<OffsetDateTime> = completionTime.getOptional("completion_time")
     ...
     *
     * Unlike [completionTime], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("completion_time")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileFileslistResponse: FileFileslistResponse) = apply {
            completionTime = fileFileslistResponse.completionTime
            error = fileFileslistResponse.error
            fileId = fileFileslistResponse.fileId
            fileSize = fileFileslistResponse.fileSize
            filename = fileFileslistResponse.filename
            status = fileFileslistResponse.status
            uploadTime = fileFileslistResponse.uploadTime
         ...
         *
         * You should usually call [Builder.completionTime] with a well-typed [OffsetDateTime] value
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FileFileslistResponse && completionTime == other.completionTime && error == other.error && fileId == other.fileId && fileSize == other.fileSize && filename == other.filename && status == other.status && uploadTime == other.uploadTime && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "FileFileslistResponse{completionTime=$completionTime, error=$error, fileId=$fileId, fileSize=$fileSize, filename=$filename, status=$status, uploadTime=$uploadTime, additionalProperties=$additionalProperties}"
}
